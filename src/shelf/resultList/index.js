          ...
          <>
            <div className="row desktpView">
              ...
              <div className="column1">
                ...
                <div className="btn_pdp--underlines-container addBag">
                  <input
              ...
              <div className="mbGridView">
                <Link to="/pdp">
                  <div className="imgListView">
                    ...
                    <span className="product__price-point">
                      <span className="product__price">
                        <span className="money">{this.props.dt.price}</span>
                      </span>
                    </span>
                  </div>
                </Link>
                <div className="productTitle">{this.props.dt.productTitle}</div>
                <span className="product__spec">
                ...
                <div className="btn--underlines-container">
                  <input
                    className="btn btn--underlines js-add-to-card"
                    type="submit"
                    value="Add to bag"
                  />
                  <svg
